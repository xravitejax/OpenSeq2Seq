...
from open_seq2seq.encoders import Wave2LetterGLUEncoder
from open_seq2seq.decoders import FullyConnectedCTCDecoderGLU
...
base_params = {
  ...
  "decoder": FullyConnectedCTCDecoderGLU,
  "decoder_params": {
    "initializer": tf.contrib.layers.xavier_initializer,
