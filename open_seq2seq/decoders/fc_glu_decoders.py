...
class FullyConnectedDecoderGLU(Decoder):
  ...
  def __init__(self, params, model,
    ...
    * **output_dim** (int) --- output dimension.
    """
    super(FullyConnectedDecoderGLU, self).__init__(params, model, name, mode)
...
class FullyConnectedTimeDecoderGLU(Decoder):
  ...
  def __init__(self, params, model,
    ...
    * **normalization** --- normalization between the layers. accepts None (default), 'weight_norm'
    ...
    """ 
    super(FullyConnectedTimeDecoderGLU, self).__init__(params, model, name, mode)
  ...
  def _decode(self, input_dict):
    ...
    if fully_connected_type == 'dense':
      ...
      out_dim = int(outputs_size)

      conv_layer = conv_wn_layer.Conv1DNetworkNormalized(in_dim, out_dim, 1, self._mode, "fcn", 1.0, "SAME", False)
      logits = conv_layer(inputs)
...
class FullyConnectedCTCDecoderGLU(FullyConnectedTimeDecoderGLU):
  ...
  @staticmethod
  def get_required_params():
    return dict(FullyConnectedTimeDecoderGLU.get_required_params(), **{
      'use_language_model': bool,
    })

  @staticmethod
  def get_optional_params():
    return dict(FullyConnectedTimeDecoderGLU.get_optional_params(), **{
  ...
  def __init__(self, params, model,
    ...
    * **valid_word_count_weight** (float) --- weight that is assigned to the
    ...
    """
    super(FullyConnectedCTCDecoderGLU, self).__init__(params, model, name, mode)
